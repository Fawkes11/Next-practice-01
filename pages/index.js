    ...
    <Layout>
      ...
      <Container>
        <Box
          ...
          align="center"
        >
          Hello, I&apos;m a full-stack developer basen in Japan!
        </Box>
        <Box display={{ md: 'flex' }}>
          <Box flexGrow={1}>
        ...
        <Section delay={0.1}>
          ...
          <Paragraph>
            ...
            camera. Currently he is living off of his own prodcut called{' '}
        ...
        <Section delay={0.2}>
          ...
          <BioSection>
            ...
            Completed the Master&apos;s Program in the graduate School of Information Science at Nara Institute of Sccence and technology
          </BioSection>
        </Section>
